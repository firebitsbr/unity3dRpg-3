...
public class FighterControl : MonoBehaviour {
    ...
    private float RunSpeed = 3.5f;//달리기속도.
...
*/
    ...
    void Start () {
        ...
        if (SceneManager.GetActiveScene().name == "Cave") {
            ...
            MoveSpeed = 1.2f;
            RunSpeed = 1.57f;
            Debug.Log("Cave="+SceneManager.GetActiveScene().name);
        }
...
*/
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        else if (other.gameObject.CompareTag("SpearAttack") == true)
        {
            HP -= 33;
            if (HP > 0)
            {
        ...
        else if (other.gameObject.CompareTag("BladeAttack") == true)
        {
            HP -= 40;
            if (HP > 0)
            {
        ...
        else if (other.gameObject.CompareTag("RockAttack") == true)
        {
            HP -= 40;
            if (HP > 0)
            {
